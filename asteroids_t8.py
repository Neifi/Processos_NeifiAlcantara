...
class World(object):
    ...
    def update(self):
        ...
        for sprite in self.sprites:
            ...
            new_center = Vector.from_position(
                sprite.rect.center) + sprite.motion
...
class Asteroid(Entity):
    def __init__(self, position):
        self.orig_image = pygame.image.load(
            '/home/neifi/Documents/Processos/UF2/Asteroid/assets/asteroid.png')
...
class Player(Entity):
    ...
    def __init__(self, position):
        self.orig_image = pygame.image.load(
            '/home/neifi/Documents/Processos/UF2/Asteroid/assets/ship.png')
...
class Bullet(Entity):
    ...
    def __init__(self, position, direction, magnitude):
        self.orig_image = pygame.image.load(
            '/home/neifi/Documents/Processos/UF2/Asteroid/assets/bullet.png')
...
def instance():
    ...
    while world.running:
        ...
        # asteroidsrPos = random.randint(0,200)

        if (timer == 70 and counter < 20):
...
def main():
    ...
    world.pew = pygame.mixer.Sound(
        '/home/neifi/Documents/Processos/UF2/Asteroid/assets/pew.wav')

    # use the clock to throttle the fps to something reasonable
   

    # main loop
    fil = threading.Thread(target=instance)
    fil.start()
